...
const Footer = () => {
  return (
    <footer className="h-[400px] sm:h-[300px] lg:h-[555px] py-16 sm:py-16 lg:py-24 bg-white">
      <div className="max-w-screen-sm sm:max-w-screen-sm lg:max-w-screen-xl h-auto sm:h-auto lg:h-[312px] w-auto mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 sm:gap-10 lg:gap-20">
        ...
        <div className="flex flex-col gap-4 sm:gap-4 lg:gap-12 ml-10 sm:ml-10 lg:ml-32">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="px-6 sm:px-6 lg:px-0">
              ...
              />
              <hr className="mt-1 sm:border-1 lg:border-2 border-black w-[200px] sm:w-[350px] " />
            </div>
            <div className="px-16 sm:px-5 lg:px-0">
              ...
              <hr className="mt-1 sm:border-1 lg:border-2 border-black w-[80px] sm:w-[90px] " />
            </div>
          </div>
        </div>
      </div>

      <div className="mt-5 sm:mt-12 lg:mt-16 text-center">
        <hr className="mt-8 sm:mt-12 lg:mt-24 sm:border-1 lg:border-1 border-[#9F9F9F] w-[300px] sm:w-[570px] lg:w-[1300px] mx-auto" />
        {/* Footer Bottom Section */}
        <div className="py-4 sm:py-6 lg:py-8 px-10 sm:px-8 lg:px-20 text-left text-[13px] sm:text-[15px] lg:text-[16px]">
